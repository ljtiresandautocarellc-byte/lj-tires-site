...
const styles = {
  ...
  header: { display: "flex", alignItems: "center", justifyContent: "space-between", padding: "12px clamp(12px, 4vw, 30px)", background: "#050505", borderBottom: "1px solid #991b1b", position: "sticky", top: 0, zIndex: 10, gap: 12, flexWrap: "wrap" },
  ...
  nav: { display: "flex", gap: 8, alignItems: "center", justifyContent: "center", flexWrap: "wrap", flex: "1 1 320px" },
  langBtn: { background: "#111", color: "#fff", border: "1px solid #dc2626", padding: "8px 11px", borderRadius: 10, cursor: "pointer", fontWeight: 800, fontSize: 12 },
  ...
  hero: { position: "relative", minHeight: "clamp(560px, 82vh, 760px)", overflow: "hidden", display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(min(100%, 330px), 1fr))", gap: 24, alignItems: "center", padding: "clamp(40px, 8vw, 70px) clamp(16px, 5vw, 50px)" },
  ...
  title: { fontSize: "clamp(38px, 12vw, 72px)", lineHeight: 1.02, fontWeight: 900, letterSpacing: "-1px", margin: "22px 0" },
  ...
  heroLogo: { position: "relative", zIndex: 4, maxWidth: 360, width: "100%", justifySelf: "center", filter: "drop-shadow(0 0 24px rgba(220,38,38,.45))" },
